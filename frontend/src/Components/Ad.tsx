...
function Ad({ ad }: Props) {
  ...
  return (
    ...
    <div  className='w-full cursor-pointer sm:px-[0px] md:py-1 max-w-[550px] xl:max-w-[680px]'>
      <div className='h-[110px] w-full md:w-[97%] flex justify-between items-center border-lightBeige border-t-2 text-[14px] transition duration:1000 hover:ease-in-out hover:shadow-lg hover:bg-white hover:bg-opacity-50 hover:border-y-2 md:h-[100px] md:border-y-2'>
        {/* LEFT SECTION */}
        <div className='h-full flex justify-start sm:gap-3'>
          ...
          <div onClick={() => navigate(`/ad/${ad?._id}`)}
            className='w-[100px] md:w-[300px] flex flex-col justify-center items-center  md:flex-row md:justify-start'
          >
            ...
            <div className='relative left-2 flex sm:flex-col justify-end gap-1 w-[100px] sm:gap-2'>
              {/* LOCATION */}
        ...
        <div
          ...
          {/* WAGE */}
          <div 
          className='w-[50px] h-[60px] flex justify-center items-center rounded-t-[20px] text-[14px]
