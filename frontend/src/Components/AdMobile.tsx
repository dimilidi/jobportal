            ...
            <div className="w-full h-full flex self-start justify-start ">
                ...
                <div className='px-3 w-[180px] flex flex-col justify-center items-start sm:w-[250px]'>
                    ...
                    <div className='w-[150px] flex  gap-1 sm:w-[200px]'>
                        {/* Location */}
                        <div className='p-1  w-[100px] flex justify-center items-center  border-2  text-[10px] text-textBlack text-opacity-50 border-lightBeige rounded-full md:w-[120px] sm:text-[12px]'>
                            <p>100% remote</p>
                        </div>
                        {/* Category */}
